...
/// <summary>
/// Represents a heap-based, array-backed output sink into which raw data can be written.
/// </summary>
public sealed class ByteBufferWriter : IBufferWriter<byte>
{
    ...
    /// <summary>
    /// Creates an instance of an <see cref="ByteBufferWriter"/>, in which data can be written to,
    ...
    /// <remarks>
    /// <para>
    /// You must reset or clear the <see cref="ByteBufferWriter"/> before trying to re-use it.
    /// </para>
    /// <para>
    ...
    private void CheckAndResizeBuffer(int sizeHint)
    {
        if (sizeHint < 0)
        {
            throw new ArgumentException("must be non-negative value.", nameof(sizeHint));
        }
...
#pragma warning disable CA2201 // Do not raise reserved exception types
        throw new OutOfMemoryException("buffer maximum size exceeded.");
